...
sys.path.append("../../../")
# print(sys.path())
import radiate_sdk.radiate as rad
...
DEBUG = False
CATS = ['car', 'truck', 'bus',
        'pedestrian', 'motorbike', 'bicycle', 'vehicle', 'van']
...
# to include lidar in fusion
# LIDAR_USED = {'LIDAR_TOP': ['LIDAR_TOP']}

# NUM_SWEEPS = 3

# suffix1 = '_{}sweeps'.format(NUM_SWEEPS) if NUM_SWEEPS > 1 else ''
OUT_PATH = OUT_PATH + "radiate/"
